...
| S2                         | MEDIUM→LOW | [#113](https://github.com/billchurch/webssh2_client/issues/113)                                                                    | Open — re-scoped (verify, not anti-MITM)                                            |
| A1                         | MEDIUM     | [#114](https://github.com/billchurch/webssh2_client/issues/114)                                                                    | Open — re-scoped (sanity-bound, not external DoS)                                   |
...
- **S2 / A1** — the gateway serves this client and is a trusted origin, so these are defensive "verify the server behaves as expected" hardenings, not external-attacker threats.
...
### S2. SFTP download filename used directly as `anchor.download` — verify it matches expectations (MEDIUM→LOW) — [#113](https://github.com/billchurch/webssh2_client/issues/113)
...
### A1. Download assembler has no size bound — sanity-check against advertised size (MEDIUM) — [#114](https://github.com/billchurch/webssh2_client/issues/114)
...
| S2  | Security     | MEDIUM→LOW | Filed [#113](https://github.com/billchurch/webssh2_client/issues/113) — verify download filename matches expectations (re-scoped)                                                                                                                            |
| A1  | Availability | MEDIUM     | Filed [#114](https://github.com/billchurch/webssh2_client/issues/114) — bound download-assembler vs expectedSize/maxFileSize (re-scoped)                                                                                                                     |
